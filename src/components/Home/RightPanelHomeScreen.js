...
function RightPanelHomeScreen() {
  return (
    <div className="bordeer-2 border-black h-screen p-8">
      ...
      <div className="flex justify-between items-center my-6">
        ...
        <div className="flex gap-4 items-center">
          ...
          <h4 className="font-semibold">
            <span className="font-semibold ">+</span> New Playground
          </h4>
        </div>
      </div>
        ...
        <Card>
          <div className="flex items-center justify-between">
            <div className="flex gap-4">
              <img src="./code-logo.png" alt="bdfbdf" width={"40px"} height={"auto"} />
              <div>
                <h4>Stack Implemenation</h4>
                <h4>Language: cpp</h4>
              </div>
            </div>
            <div className="flex gap-4 items-center">
